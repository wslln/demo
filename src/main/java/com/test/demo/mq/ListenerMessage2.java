...
/**
 * 监听消息，与ListenerMessage竞争
 *
 * @author zhout 2022/4/5 6:02 下午
 */
@Slf4j
@Component
...
public class ListenerMessage2 implements StreamListener<String, MapRecord<String, String, String>> {
    ...
    public void onMessage(MapRecord<String, String, String> message) {
        log.info("ListenerMessage2-监听 ==> recordId={}, stream={}, value={}", message.getId(), message.getStream(), message.getValue());
        ...
        try {
            ...
            log.error("ListenerMessage2 Error：json:{}", message);
